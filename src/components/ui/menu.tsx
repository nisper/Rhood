...
function Menu({ align = "left", className, children, ...props }: MenuProps) {
  return (
    <div
      className={cn(
        "flex w-max flex-col rounded-[var(--rh-sizing-border-radius-lg)] bg-[var(--rh-theme-fill-contrast)] p-[var(--rh-sizing-menu-padding-menu-px)] shadow-[0_3px_14px_rgba(0,0,0,0.25)] [&>*]:w-full",
