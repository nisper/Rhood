  ...
  return (
    <div className="grid min-w-0 gap-10">
      ...
      <Section description="Каждому вложенному InputNumber можно передать его обычные props — например, единицу измерения и форматирование." settings={["startInputProps: InputNumberProps", "endInputProps: InputNumberProps", "separator: ReactNode"]} title="Наполнение">
        <ShowcaseSurface><ShowcasePanel><div className="grid w-full gap-5 sm:grid-cols-2"><Cell label="Значения"><EditableRange /></Cell><Cell label="Единица измерения"><InputNumberRange endInputProps={{ endText: "м²", value: "120" }} startInputProps={{ endText: "м²", value: "25" }} /></Cell><Cell label="Префикс"><InputNumberRange endInputProps={{ startText: "от", value: "120" }} startInputProps={{ startText: "от", value: "25" }} /></Cell><Cell label="Обязательное"><InputNumberRange endInputProps={{ required: true, value: "120" }} startInputProps={{ required: true, value: "25" }} /></Cell><Cell label="groupThousands: true"><InputNumberRange endInputProps={{ groupThousands: true, value: "1000000" }} startInputProps={{ groupThousands: true, value: "500000" }} /></Cell></div></ShowcasePanel></ShowcaseSurface>
      </Section>
