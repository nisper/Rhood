...
export function InputNumberExamples() {
  return <div className="grid min-w-0 gap-10">
    ...
    <Section description="Поле поддерживает префикс, единицу измерения и обязательность; числовое значение остаётся моноширинным." settings={["startText: ReactNode", "endText: ReactNode", "required: boolean", "groupThousands: boolean"]} title="Наполнение">
      <ShowcaseSurface><ShowcasePanel><div className="grid w-full gap-5 sm:grid-cols-2"><Cell label="value"><EditableNumber initialValue="2007" /></Cell><Cell label="endText"><EditableNumber endText="м²" initialValue="2007" /></Cell><Cell label="startText"><EditableNumber initialValue="2007" startText="с" /></Cell><Cell label="required"><EditableNumber initialValue="2007" required /></Cell><Cell label="groupThousands"><EditableNumber groupThousands initialValue="1000000" /></Cell></div></ShowcasePanel></ShowcaseSurface>
    </Section>
