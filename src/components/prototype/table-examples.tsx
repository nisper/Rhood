...
const compositionSnippet = (
  <Snippet>
    ...
    <span className={component}>TableCell</span>{" "}
    <CodeProp name="role" value={'"head"'} />{" "}
    <CodeProp name="type" value={'"number"'} /> <CodeProp name="sort" />
  ...
  return (
    <div className="grid min-w-0">
      ...
      <ShowcaseSection
        ...
        description="Выбор работает через Table.selection: передай ID всех строк, выбранные ID и обработчик изменения. Для checkbox в строке обязательно укажи соответствующий rowId; checkbox в шапке выберет все строки. Нажми на «Объект» или «Стоимость», чтобы проверить сортировку и hover."
        showcase={
          <ShowcaseSurface>
            <ShowcasePanel>
              <Table
              ...
              >
                ...
                >
                  ...
                  <TableCell
                    ...
                    sort
                    sortDirection={
                      sort?.column === "object" ? sort.direction : undefined
                    }
                    type="text"
                    width="fill"
                  >
                  ...
                  <TableCell
                    ...
                    sort
                    sortDirection={
                      sort?.column === "price" ? sort.direction : undefined
                    }
                    type="number"
                    width={150}
                  >
