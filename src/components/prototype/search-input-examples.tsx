...
export function SearchExamples() {
  return <div className="grid min-w-0 gap-10">
    <Section description="md — основной размер поля; sm — компактный вариант для плотных панелей и фильтров." title="Размер">
    ...
    <Section description="Hover и focus относятся к состояниям интерактивного поля. Disabled имеет приоритет и блокирует ввод." title="Состояния">
    ...
    <Section description="Иконка поиска зафиксирована слева. Содержание поля задаётся стандартными props Input: placeholder, value и defaultValue." title="Наполнение">
